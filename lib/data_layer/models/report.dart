...
class Report extends Equatable{
  int id=0; //in the real API id is generated by automatically
  String name;
  Location location;
  String radioValue;
  ...
  Report({this.id,this.name, this.location, this.radioValue, this.choices, this.description, this.imagesPath,this.dateTime});

  Report copyWith({int id,String name,String location,String radioValue,List<MultipleChoices> choices,String description,List<Images> imagesPath}){
    return Report(
      id: this.id??id,
      name: this.name??name,
